...
<input type="hidden" name="postingDeadline" value="${posting.postingDeadline}">
	...
	기업 전화번호 : 	${company.companyPhone }
                        ...
                        <div class="d-flex mt-4 justify-content-center">
							<div class="px-2">
							<a href="/postingEditForm?postingIdx=${posting.postingIdx}"id="edit-posting" class="btn btn-primary">수정하기</a>   <a href="/postings" id="cancel-posting" class="btn btn-primary">목록으로</a>
                       		</div>
						</div>
					</div>
