...
<div class="mt-5">
<input type="text" class="form-control w-100" name="postingTitle" style="text-align:center;" placeholder="공고 제목을 입력해주세요" required>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mt-5">
			<div class="input-group mb-3">
				...
				<input type="text" name="empType" class="form-control" required>
			</div>
			<div class="input-group mb-3">
		    ...
		    <div class="input-group mb-3">
		        ...
		        <input type="text" name="postingAddress" class="form-control" required>
		    </div>
  		</div>
		...
		<div class="col-md-6 mt-5">
		    <div class="input-group mb-3">
		        ...
		        <label class="form-control"><input type="time" name="startTime" value="09:00" required> ~ <input type="time" name="endTime" value="18:00" required></label>
		    </div>
		    <div class="input-group mb-3">
...
<c:forEach var="skill" items="${skill}">
	...
	기업 전화번호 : 	${company.companyPhone }
                        ...
                        <div class="d-flex mt-4 justify-content-center">
							<div class="px-2">
							<button type="submit" id="save-write" class="btn btn-primary">공고등록</button>   <a href="/postings" id="cancel-posting" class="btn btn-primary">목록으로</a>
                       		</div>
						</div>
					</div>
