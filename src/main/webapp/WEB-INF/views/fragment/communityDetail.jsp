...
<div class="border container py-3">
	...
	<div class="container d-flex my-2">
		...
		<div class="ms-3">
			<span class="like_btn" data-community-idx="${community.communityIdx}">
...
<div class="border container py-3 mt-2 mb-3">
	...
	<div class="mt-3 row">
		<textarea class="form-control replyBox col" placeholder="댓글 달기..." data-community-idx="${community.communityIdx}"
