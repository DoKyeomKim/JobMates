	...
	<c:if test="${not empty posts}">
		<div class="d-flex flex-wrap">
			...
			<c:forEach items="${posts}" var="post">
				<div class="me-5 detail-div" data-posting-idx="${post.postingDto.postingIdx}">
					<!-- 각 포스트를 감싸는 div 추가 -->
					...
					<div class="d-flex justify-content-between">
						...
						<svg class="w-10 h-10 text-gray-800 dark:text-white scrapBtn end-0" data-posting-idx="${post.postingDto.postingIdx}"
							aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="32"
