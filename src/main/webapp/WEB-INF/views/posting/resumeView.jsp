...
<input type="hidden" name="publish" value=1>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mt-5">
            <img src="${resumeFile.filePath}" id="imagePreview" style="width:250px; height: 310px;" class="mb-2 border border-tertiary">
        </div>
					...
					<input type="hidden" id="defaultSkillIdx" name="skillIdx" value="0">
                         ...
                         <div  style="margin-top:15px;">
                             ...
                             <div class="d-flex mt-4 justify-content-center">
                                 <div class="px-2">
                                     <a href="/resumeEditForm?resumeIdx=${resume.resumeIdx}"id="edit-resume" class="btn btn-primary">수정하기</a>   <a href="/resumes" id="cancel-resume" class="btn btn-primary">목록으로</a>
                                 </div>
                             </div>
                         </div>
