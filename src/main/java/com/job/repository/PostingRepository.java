...
public interface PostingRepository extends JpaRepository<Posting, Long> {
	...
	List<Posting> findPostingByConditions(@Param("region") String region, @Param("experience") String experience,
			@Param("selectedSkills") List<Long> selectedSkills, @Param("selectedJobs") List<String> selectedJobs);
